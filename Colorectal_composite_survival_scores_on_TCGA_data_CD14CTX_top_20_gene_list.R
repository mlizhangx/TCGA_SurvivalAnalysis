...
#### KM plot over all ####
pdf(paste0("./figures/Colorectal KM plot on median Composite survival score ", cluster_id, " the most positive fold change in the RvNR ", Top_N," gene list plot.pdf"))
